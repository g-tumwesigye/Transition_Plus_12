...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Operation/</span> Register New Operation</h4>
    ...
    <div class="row">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
            <form action="{{route('operation.create')}}" method="POST">
                @csrf
                <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    <select
                        ...
                        name="player"
                    >
                    <option value="" selected hidden>Select Player</option>
                    @foreach ($players as $player)
                    <option value="{{$player->player_id}}" {{old('player')==$player->player_id?'selected':''}}>{{ $player->name }}</option>
                    @endforeach
                    </select>
                    </div>
